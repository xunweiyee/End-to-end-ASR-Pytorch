...
```
[INFO] Saved checkpoint (step = 76.0K, wer = 0.21) and status @ ckpt/asr_example_run_sd0/best_ctc.pth
Extractor: vgg  Eval    Epoch 0 Step 76000      CTC Loss 1.16493        WER(att) nan    (ctc) 0.20972   lr      ctc_weight 1
Extractor: vgg  Train   Epoch 0 Step 76000      CTC Loss 3.53149        WER(att) nan    (ctc) 0.20901   lr      ctc_weight 1

Saved checkpoint (step = 125.0K, wer = 0.16) and status @ ckpt/asr_example_sd0/best_ctc.pth
Saved checkpoint (step = 125.0K, wer = 0.16) and status @ ckpt/asr_example_sd0/best_ctc.pth# End-to-end Automatic Speech Recognition Systems - PyTorch Implementation
...
Extractor: mlp  Train   Epoch 1 Step 208000     CTC Loss 6.79097        WER(att) nan    (ctc) 0.96228   lr      ctc_weight 1
Extractor: vgg sPre-Classifier: mlp     Eval    Epoch 3 Step 488000     CTC Loss 3.30768        WER(att) nan    (ctc) 0.50459   lr      ctc_weight 1
Extractor: vgg  Pre-Classifier: mlp     Train   Epoch 3 Step 488000     CTC Loss 1.85045        WER(att) nan    (ctc) 0.35247   lr      ctc_weight 1